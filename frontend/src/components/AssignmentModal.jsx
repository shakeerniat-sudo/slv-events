...
const AssignmentModal = ({ event, onClose }) => {
  ...
  if (loading) {
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
        <div className="w-full max-w-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 flex flex-col justify-center items-center shadow-2xl min-h-[300px]">
          <Loader2 className="w-10 h-10 animate-spin text-sky-500 mb-4" />
          <p className="text-xs font-bold text-slate-500 dark:text-slate-400 animate-pulse uppercase tracking-wider">
  ...
  // Summary feedback overlay once successfully saved
  if (successSummary) {
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-fade-in">
        <div className="w-full max-w-md bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-2xl animate-modal-zoom relative transition-colors">
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 overflow-y-auto">
      <div className="w-full max-w-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-2xl my-8 max-h-[90vh] overflow-y-auto flex flex-col transition-colors animate-modal-zoom">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-1">
                <label className="block text-[11px] font-bold text-slate-500 dark:text-slate-450 uppercase tracking-wide">Decorator</label>
